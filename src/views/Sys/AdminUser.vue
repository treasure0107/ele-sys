<template>
  <div class="panel">
    ...
    <!--	<div class="btn-contanier">
              <el-button type="success" size="medium" @click="add">新增数据</el-button>
              <el-button type="info" size="medium" @click="disable">禁用数据</el-button>
              <el-button type="primary" size="medium" @click="enable">启用数据</el-button>
              <el-button type="danger" size="medium" @click="del">删除数据</el-button>
          </div>-->
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <button class="bts-btn del" v-if="" @click="updateByIDs(-1,'删除数据',scope.row.UserID)"><i class="fa fa-trash-o"></i>
          </button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="isEdit" :visible.sync="dialogVisible" width="580px">
    ...
    methods: {
      ...
      getAdminRolesList(){
        try {
          let config = {
            method: "GET",
            url: baseUrl + "SysApi/GetAllAdminRolesListForList",
          };
