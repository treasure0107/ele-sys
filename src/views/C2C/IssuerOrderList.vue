        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span v-if="scope.row.Tradetype == 0" style="color: #39B6AE">买单</span>
              <span v-if="scope.row.Tradetype == 1" style="color: #EF6F66">卖单</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="CoinUnit"
          ...
          <el-table-column
            label="操作">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" v-if="isPath==2&&scope.row.IussueStatus==0" @click="goAppeal(scope.row.OrderId)">审核</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
