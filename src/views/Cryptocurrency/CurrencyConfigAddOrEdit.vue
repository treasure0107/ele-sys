...
//              ContractAddress
              /* this.form.CurrencyName = data.CurrencyName;
               this.form.CurrencyName_EN = data.CurrencyName_EN;
               this.form.IconUrl = data.IconUrl;
               this.form.QrCodePrefix = data.QrCodePrefix;
               this.form.Unit = data.QrCodePrefix;
               this.form.Symbol = data.Symbol;
               this.form.WalletIP = data.WalletIP;
               this.form.WalletPort = data.WalletPort;
               this.form.WalletUserName = data.WalletUserName;
               this.form.WalletPassword = data.WalletPassword;
               this.form.WalletPassphrase = data.WalletPassphrase;
               this.form.MainBlockAddress = data.MainBlockAddress;
               this.form.ColdBlockAddress = data.ColdBlockAddress;
               this.form.MinAggregateAmount = data.MinAggregateAmount;
               this.form.ContractAddress = data.ContractAddress;
               this.form.TokenDecimals = data.TokenDecimals;
               this.form.DepositAccount = data.DepositAccount;
               this.form.DepositAccount_EN = data.DepositAccount_EN;
               this.form.ConfirmCount = data.ConfirmCount;
               this.form.DecimalDigits = data.DecimalDigits;
               this.form.DepositTips = data.DepositTips;
               this.form.DepositTips_EN = data.DepositTips_EN;
               this.form.WithdrawTips = data.WithdrawTips;
               this.form.WithdrawTips_EN = data.WithdrawTips_EN;
