    ...
    <section>
      <el-form ref="form" :model="form" label-width="200px" class="form">
        ...
        <el-form-item label="发行总量">
          <el-input v-model="form.IssueVolume"><span slot="append">万</span></el-input>
        </el-form-item>
        <el-form-item label="流通总量">
          <el-input v-model="form.MarketVolume "><span slot="append">万</span></el-input>
        </el-form-item>
        <el-form-item label="众筹价格">
          <el-input v-model="form.Price"><span slot="append">美元</span></el-input>
        </el-form-item>
