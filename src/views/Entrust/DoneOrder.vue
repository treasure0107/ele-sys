      ...
      <div>
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span v-if="scope.row.IsBuyPrimary == 1"
                    style="color: #39B6AE">{{scope.row.TradePrice}}({{scope.row.ExchangeUnit}})</span>
              <span v-else
                    style="color: #EF6F66">{{scope.row.TradePrice}}({{scope.row.ExchangeUnit}})</span>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
             <span v-if="scope.row.IsBuyPrimary == 1"
                   style="color: #39B6AE">{{scope.row.TradeVolume}}({{scope.row.Unit}})</span>
              <span v-else style="color: #EF6F66">{{scope.row.TradeVolume}}({{scope.row.Unit}})</span>
            </template>
          </el-table-column>
          <el-table-column
            label="成交额"
            ...
            <template slot-scope="scope">
             <span v-if="scope.row.IsBuyPrimary == 1" style="color: #39B6AE">
               <span
                 v-text="(scope.row.TradeVolume*scope.row.TradePrice).toFixed(8)"></span><span>({{scope.row.ExchangeUnit}})</span>
               </span>
