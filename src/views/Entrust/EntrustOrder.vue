      ...
      <div>
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span v-if="scope.row.IsBuy == 1"
                    style="color: #39B6AE">{{scope.row.EntrustPrice}}({{scope.row.ExchangeUnit}})</span>
              <span v-if="scope.row.IsBuy == 0"
                    style="color: #EF6F66">{{scope.row.EntrustPrice}}({{scope.row.ExchangeUnit}})</span>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span v-if="scope.row.IsBuy == 1"
                    style="color: #39B6AE">{{scope.row.EntrustVolume}}({{scope.row.Unit}})</span>
              <span v-if="scope.row.IsBuy == 0"
                    style="color: #EF6F66">{{scope.row.EntrustVolume}}({{scope.row.Unit}})</span>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            width="190">
            <template slot-scope="scope">
              <span>{{scope.row.CompletedVolume}}</span>
              <span>({{scope.row.Unit}})</span>
            </template>
          </el-table-column>
          <el-table-column
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span v-if="scope.row.IsBuy == 1"
                    style="color: #39B6AE">{{scope.row.TradeFees}}({{scope.row.Unit}})</span>
              <span v-if="scope.row.IsBuy == 0"
                    style="color: #EF6F66">{{scope.row.TradeFees}}({{scope.row.ExchangeUnit}})</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="EntrustStatus"
